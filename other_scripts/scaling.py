...
holder = convert_meshlab_data(
    name="Holder (CAD)",
    V_mm3=153296.078125,
    CoM_mm=[-0.02, -0.00, 34.87],
    I_meshlab=[
        [167907232.000000, -95.849602, 164078.109375],
        [-95.849602, 167574288.000000, -200.701126],
        [164078.109375, -200.701126, 57708340.000000],
    ],
    rho_kg_m3=RHO_PLA,
)
...
cut_rod = convert_meshlab_data(
    name="Cut Rod",
    V_mm3=17385.410156,
    CoM_mm=[-29.30, 0.0, 80.99],
    I_meshlab=[
        [308658.031250, 23.858063, -11.122323],
        [23.858063, 36422408.000000, 15.397009],
        [-11.122323, 15.397009, 36422472.000000],
    ],
    rho_kg_m3=RHO_ROD,
)

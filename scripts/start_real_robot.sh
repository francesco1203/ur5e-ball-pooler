...
reverse_ip="192.168.56.1"       #il tuo ip sulla rete del robot
#------------------------------------------------
...
EOF
    ...
    echo -e "Saltato l'avvio del driver, passo direttamente all'esecuzione.\nAssicurati manualmente che sia tutto pronto!"
fi
